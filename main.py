    ...
    while True:
        ...
        if 1 <= player_move <= 9:
            if field[player_move] == "X" or field[player_move] == "O":
                print("Spielfeld ist bereits belegt")
            else:
                return player_move
        else:
            print("Die eingegebene Zahl muss zwischen 1 und 9 liegen. Bitte die Eingabe wiederholen.")
...
def check_draw():
    if field[1] != "1" and field[2] != "2" and field[3] != "3" and field[4] != "4" and field[5] != "5" and field[
        6] != "6" and field[7] != "7" and field[8] != "8" and field[9] != "9":
        return True
